...
lay=. (glRollLevelVal i. >0{ each rolllevel) { glRollLevelDescwrite_xl hole ; tee ; gender ; (hole+1) ; 57 ; 5 7 ; 0 ; 'Roll Up/Down' ; < (glRollLevelVal i. >0{ each rolllevel) { glRollLevelText
